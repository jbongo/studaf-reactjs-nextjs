...
import TopMenuHome from './pages/TopMenu/TopMenuHome';
import Footer from './pages/Footer/Footer'
import Blog from './pages/Blog/Blog';
import Article from './pages/Blog/Article';
import ProfileRecru from './pages/Recruteur/Profile';
import Job from './pages/Recruteur/Job';
import ResumeRecru from './pages/Recruteur/Resume';
import AddJob from './pages/Recruteur/AddJob';
import AlertsRecru from './pages/Recruteur/Alerte';
import ChangePassword from './pages/Authentification/ChangePassword';

import ProfileCandi from './pages/Candidat/Profile';
import Favoris from './pages/Candidat/Favori';
import AlertsCandi from './pages/Candidat/Alert';
import ResumeCandi from './pages/Candidat/Resume';
import Candidatures from './pages/Candidat/Candidature';
import Offre from './pages/Offres/Offre';
