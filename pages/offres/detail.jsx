				...
				<div className="row">
				 	<div className="col-lg-8 column">
				 		<div className="job-single-sec">
				 			<div className="job-single-head2">
				 				<div className="job-title2"><h3>Senior Web Designer</h3><span className="job-is ft">Full time</span><i className="la la-heart-o"></i></div>
				 				<ul className="tags-jobs">
				 					<li><i className="la la-map-marker"></i> Sacramento, California</li>
				 					<li><i className="la la-money"></i> Monthly Salary : <span>$3000 - $5000</span></li>
				 					<li><i className="la la-calendar-o"></i> Post Date: July 29, 2017</li>
				 				</ul>
				 	...
				 	<div className="col-lg-4 column">
				 		<div className="job-single-head style2">
			 				<div className="job-thumb"> <img src="http://placehold.it/124x124" alt="" /> </div>
			 				...
			 				<a href="#" title="" className="apply-job-btn"><i className="la la-paper-plane"></i>Apply for job</a>
			 				<a href="#" title="" className="apply-job-linkedin"><i className="la la-linkedin"></i>Apply with Linkedin</a>
